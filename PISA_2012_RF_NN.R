...
train(CNT~., data=PISA2012, method="rf", trConrtol=keresztval) #mtry 34 a legjobb, 0.9687285 accuracy
...
library("MatchIt")
scores <- c(PS$PS)
match <- matchit(CNT~.-PV1MATH-PV1READ-PV1SCIE, data = PISA2012, distance="randomforest", mtry=34, method = "nearest")
