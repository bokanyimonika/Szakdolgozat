...
train(CNT~., data=PISA2018, method="rpart", trControl=keresztval)
...
library("MatchIt")
match <- matchit(CNT~.-PV1MATH-PV1READ-PV1SCIE-PERCOOP, data = PISA2018, distance="randomforest", mtry=30, method = "nearest")
