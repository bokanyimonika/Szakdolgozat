...
## ---------------------------------------------------------------------------------------------------------------------
xvars <- c("Nem","OF","Könyvek","SzT","IK","TB","OV","TK","TS","TO","TanÉsMunka","OED","DE","WeeklyClass","MISCED","FIECED","BMMJ_Mother","BFMJ_Father","MINS_Maths","MINS_Language","ESCS","ICT_Home","ICT_School","WLE_Cultural","WLE_Home","WLE_Wealth","WLE_INSTRUCTION","WLE_TeacherFairness","WLE_Emotional","WLE_SchoolWellBeing","CPSVALUE","PERFEED")
library(tableone)
...
## ---------------------------------------------------------------------------------------------------------------------
library("MatchIt")
match <- matchit(CNT~.-PV1MATH-PV1READ-PV1SCIE, data = PISA2015, distance="randomforest", mtry=34, method = "nearest")
